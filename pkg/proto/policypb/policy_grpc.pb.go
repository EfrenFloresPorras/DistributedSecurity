...
const (
	PolicyService_CheckPolicy_FullMethodName = "/policy.PolicyService/CheckPolicy"
)
...
type PolicyServiceClient interface {
	CheckPolicy(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *policyServiceClient) CheckPolicy(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, PolicyService_CheckPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PolicyServiceServer interface {
	CheckPolicy(context.Context, *CheckRequest) (*CheckResponse, error)
...
func (UnimplementedPolicyServiceServer) CheckPolicy(context.Context, *CheckRequest) (*CheckResponse, error) {
...
func _PolicyService_CheckPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyService_CheckPolicy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).CheckPolicy(ctx, req.(*CheckRequest))
	}
